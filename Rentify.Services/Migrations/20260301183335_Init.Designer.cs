            ...
            modelBuilder.Entity("Rentify.Services.Database.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6393),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6395),
            ...
            modelBuilder.Entity("Rentify.Services.Database.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6525),
                            ...
                            IsVlasnik = true,
                            LastName = "Petrov",
                            PasswordHash = "YhfiqcqWJ8k44HLVFxRw0rUQmnKj/ntVVSAWZg+97J8tmV+1AUZjSWbXGD5JrGvrCXj1Ga1GOWDQ6ghPgRul6w==",
                            PasswordSalt = "gi1YkEudvLzDk7tFnT3D6inE16YowuhxlVXKGrUOKH2P1GlBOpgGSl5eEP8kL5sekUM0Bp+czNYsYvngWP7ERSk7XRcCEVAAOAajQJN8R/EiuMHxPwMUd4Vpg19JiLtGDwe4lIEOc7Nna69e5z5sz8nBBmdn4FNBxgUe3v4lyCw=",
                            Username = "owner1"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6534),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6537),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6540),
            ...
            modelBuilder.Entity("Rentify.Services.Database.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 2,
                            DateAssigned = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6572),
                            Id = 0
                        },
                        new
                        {
                            UserId = 2,
                            RoleId = 1,
                            DateAssigned = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6574),
                            Id = 0
                        },
                        new
                        {
                            UserId = 3,
                            RoleId = 2,
                            DateAssigned = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6575),
                            Id = 0
                        },
                        new
                        {
                            UserId = 4,
                            RoleId = 1,
                            DateAssigned = new DateTime(2026, 3, 1, 18, 33, 35, 284, DateTimeKind.Utc).AddTicks(6576),
                            Id = 0
                        });
                });
